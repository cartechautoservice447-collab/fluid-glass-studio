...
export function EngineSettingsModal({ trigger = "button", userId }: Props) {
  ...
  return <>
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto border-white/25 bg-white/10 backdrop-blur-2xl sm:max-w-lg" style={{ backdropFilter: "blur(calc(var(--liquid-blur-effective, var(--liquid-density, 12px)) + 8px)) saturate(170%)" }}>
