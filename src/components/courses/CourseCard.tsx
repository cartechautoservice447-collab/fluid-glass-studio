    ...
    <>
      ...
      >
        ...
        >
          ...
          <button type="button" onClick={confirmDelete} className="absolute bottom-3 right-3 z-40 flex size-7 items-center justify-center text-foreground/65 transition-colors hover:text-foreground focus-visible:outline-none" aria-label={`Delete ${course.name}`} title="Delete course">
