  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col gap-6 overflow-y-auto px-2 py-2">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <button
          type="button"
          onClick={() => courses[0] && onOpenCourse(courses[0].id)}
          disabled={courses.length === 0}
          className="liquid-panel group flex min-h-28 items-center gap-4 rounded-3xl p-5 text-left transition duration-200 hover:-translate-y-0.5 hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-50"
          style={{
            backgroundColor: "var(--water-gel-bg)",
        ...
        >
          ...
          <span>
            <span className="block text-base font-semibold text-foreground">Notebook</span>
            <span className="mt-1 block text-xs text-muted-foreground">
              {courses.length ? "Open your notes workspace" : "Create a course first"}
            </span>
          </span>
        </button>
        ...
        <button
          ...
          className="liquid-panel group flex min-h-28 items-center gap-4 rounded-3xl p-5 text-left transition duration-200 hover:-translate-y-0.5 hover:brightness-110"
          style={{
            backgroundColor: "var(--water-gel-bg)",
            backdropFilter: "blur(var(--liquid-density, 12px)) saturate(180%)",
            borderTop: "1px solid rgba(255,255,255,.32)",
        ...
        >
          ...
          <span>
            ...
            <span className="mt-1 block text-xs text-muted-foreground">Focus with a timer</span>
          </span>
        </button>
      </div>
