export function ReleaseDownloadLinks() {
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <a href="https://github.com/cartechautoservice447-collab/fluid-glass-studio/releases/latest/download/Liquid-Glass-Studio-Windows.zip" className="rounded-full border border-white/10 bg-black/50 px-3 py-2 text-xs text-white/80 backdrop-blur-xl">
